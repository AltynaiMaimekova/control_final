...
place1 = user1.places.create!(title: 'Alibaba', description: "Good place for rest", agreement: true, status: false, category: category1, image: File.new("app/assets/images/summer.jpg"))
place2 = user1.places.create!(title: 'Navigator', description: "Good place for rest", agreement: true, status: false, category: category2, image: File.new("app/assets/images/summer.jpg"))
place3 = user1.places.create!(title: 'Moskva', description: "Good place for rest", agreement: true, status: false, category: category3, image: File.new("app/assets/images/summer.jpg"))
place4 = user2.places.create!(title: 'Frunze', description: "Good place for rest", agreement: true, status: false, category: category4, image: File.new("app/assets/images/summer.jpg"))
place5 = user2.places.create!(title: 'Faiza', description: "Good place for rest", agreement: true, status: false, category: category1, image: File.new("app/assets/images/summer.jpg"))
place6 = user2.places.create!(title: 'Bella Italia', description: "Good place for rest", agreement: true, status: false, category: category2, image: File.new("app/assets/images/summer.jpg"))
